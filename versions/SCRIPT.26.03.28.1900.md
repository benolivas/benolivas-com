# BEN OS — Script
**Version: 2.5 — ARCHIVED SNAPSHOT: 26.03.28.1900**
...
**Asset migration — move these before old benolivas.com goes down:**

| File needed | Migrate from | Destination |
|---|---|---|
| after-hours thumb | benolivas.com/images/CaseStudies/afterhours.gif | assets/portfolio/graphic-design/after-hours/thumb.gif |
| misfortune-cookies thumb | benolivas.com/images/CaseStudies/misfortunes.gif | assets/portfolio/graphic-design/misfortune-cookies/thumb.gif |
| man-ray-chess thumb | benolivas.com/images/CaseStudies/chess.gif | assets/portfolio/graphic-design/man-ray-chess/thumb.gif |
| JUMP 20 thumb | benolivas.com/images/Thumbnails/jump20SM.png | assets/portfolio/video/aerovironment/jump-20/thumb.jpg |
| Asana thumb | benolivas.com/images/Thumbnails/crystal.png | assets/portfolio/video/commercials/asana/thumb.jpg |
| NoMBe thumb | benolivas.com/images/Thumbnails/stayoverSM.png | assets/portfolio/video/music-videos/nombe/thumb.jpg |
| Onibaba poster | benolivas.com/images/GraphicDesign/OnibabaPoster.png | assets/portfolio/graphic-design/posters/full/onibaba.jpg |
| Swiss Design poster | benolivas.com/images/GraphicDesign/SwissStylePoster.png | assets/portfolio/graphic-design/posters/full/swiss-design.jpg |
| Voltaire poster | benolivas.com/images/GraphicDesign/VoltairePoster.jpg | assets/portfolio/graphic-design/posters/full/voltaire.jpg |

**Assets to create (don't exist yet):**
- `assets/portfolio/graphic-design/posters/thumb.gif` — representative poster thumb for design grid
- `assets/portfolio/graphic-design/blue-note/thumb.jpg` — Blue Note work thumb (work TBD)
- `assets/portfolio/graphic-design/aerovironment/thumb.jpg` — AeroVironment work thumb
- `assets/memes/open-sesame.gif` — easter egg, not yet sourced
- `assets/generated/album-covers/` — fake album covers for magic tricks
- `assets/generated/ui/` — generated UI elements
